...
import { SignalEvents } from '../events/vg-events'
...
export class VgMedia implements OnInit, OnDestroy, IPlayable {
	...
	ngOnInit() {
		...
		this.subscriptions = {
			// Native events
			abort: Observable.fromEvent(<any>this.elem, SignalEvents.VG_ABORT),
			canPlay: Observable.fromEvent(<any>this.elem, SignalEvents.VG_CAN_PLAY),
			canPlayThrough: Observable.fromEvent(<any>this.elem, SignalEvents.VG_CAN_PLAY_THROUGH),
			durationChange: Observable.fromEvent(<any>this.elem, SignalEvents.VG_DURATION_CHANGE),
			emptied: Observable.fromEvent(<any>this.elem, SignalEvents.VG_EMPTIED),
			encrypted: Observable.fromEvent(<any>this.elem, SignalEvents.VG_ENCRYPTED),
			ended: Observable.fromEvent(<any>this.elem, SignalEvents.VG_ENDED),
			error: Observable.fromEvent(<any>this.elem, SignalEvents.VG_ERROR),
			loadedData: Observable.fromEvent(<any>this.elem, SignalEvents.VG_LOADED_DATA),
			loadedMetadata: Observable.fromEvent(<any>this.elem, SignalEvents.VG_LOADED_METADATA),
			loadStart: Observable.fromEvent(<any>this.elem, SignalEvents.VG_LOAD_START),
			pause: Observable.fromEvent(<any>this.elem, SignalEvents.VG_PAUSE),
			play: Observable.fromEvent(<any>this.elem, SignalEvents.VG_PLAY),
			playing: Observable.fromEvent(<any>this.elem, SignalEvents.VG_PLAYING),
			progress: Observable.fromEvent(<any>this.elem, SignalEvents.VG_PROGRESS),
			rateChange: Observable.fromEvent(<any>this.elem, SignalEvents.VG_RATE_CHANGE),
			seeked: Observable.fromEvent(<any>this.elem, SignalEvents.VG_SEEKED),
			seeking: Observable.fromEvent(<any>this.elem, SignalEvents.VG_SEEKING),
			stalled: Observable.fromEvent(<any>this.elem, SignalEvents.VG_STALLED),
			suspend: Observable.fromEvent(<any>this.elem, SignalEvents.VG_SUSPEND),
			timeUpdate: Observable.fromEvent(<any>this.elem, SignalEvents.VG_TIME_UPDATE),
			volumeChange: Observable.fromEvent(<any>this.elem, SignalEvents.VG_VOLUME_CHANGE),
			waiting: Observable.fromEvent(<any>this.elem, SignalEvents.VG_WAITING),

			// Advertisement only events
			startAds: Observable.fromEvent(<any>window, SignalEvents.VG_START_ADS),
			endAds: Observable.fromEvent(<any>window, SignalEvents.VG_END_ADS),

			// See changes on <source> child elements to reload the video file
			mutation: Observable.create((observer: any) => {
	...
	prepareSync() {
		...
		this.canPlayAllSubscription = Observable.combineLatest(canPlayAll, (...params) => {
