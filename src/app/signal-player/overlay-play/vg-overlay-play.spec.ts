...
describe('Videogular Player', () => {
	...
	describe('getState', () => {
		...
		it('if more than one target should return pause if all of them are pause', () => {
			overlayPlay.target.state = [VgStates.VG_PAUSED, VgStates.VG_PAUSED, VgStates.VG_PAUSED, VgStates.VG_PAUSED]

			expect(overlayPlay.getState()).toEqual(VgStates.VG_PAUSED)
		})

		it('if more than one target should return play if any of them is play', () => {
			overlayPlay.target.state = [VgStates.VG_PAUSED, VgStates.VG_PLAYING, VgStates.VG_PAUSED, VgStates.VG_PAUSED]
